...
Adapted from Aaron Schein's code: https://github.com/aschein/bptf
Uses an CAVI-like algorithm with Gamma priors: MAP estimation
"""
import sys
import time
import numpy as np
...
class BPTF(BaseEstimator, TransformerMixin):
    def __init__(self, n_modes=4, n_components=100,  max_iter=200, tol=0.0001,
                 smoothness=100, verbose=True, alpha=0.1, debug=False,seed=10):
    ...
    def _bound(self, data, mask=None):
